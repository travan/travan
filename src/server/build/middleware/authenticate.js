...
const JWT_SECRET = accesEnv_1.jwtSecret || "";
const registerUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield Users_model_1.default.findOne({ username, password, email });
        if (user) {
            throw new Error('Username already exists');
        }
        const hashedPassword = yield bcrypt_1.default.hash(password, 10);
        const newUser = new Users_model_1.default({ username, password: hashedPassword, email });
        yield newUser.save();
